...
if ((len(sys.argv) < 9)):
    print """\
This script calculates Average Importance and Average Age for each device in OneSimulator

Usage:  python importanceCalculation_OneSimulator.py ../data/disarm/EventGen.txt ../reports/disarm_importance_test_EventLogReport.txt intervalTime DeviceName
"""
    sys.exit(1)
